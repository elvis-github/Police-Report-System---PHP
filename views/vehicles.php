...
?>
    <div class="container">
        <div class="text-center mt-3">
            ...
            <a class="btn btn-outline-success" href="../new/vehicle.php">Add New Vehicle</a><br>
    ...
    <script>
        ...
        function filter() {
            ...
            for (i = 0; i < tr.length; i++) {
                tdLicence = tr[i].getElementsByTagName("td")[2];
                if (tdLicence) {
                    txtValueLicence = tdLicence.textContent || tdLicence.innerText;
                    if (txtValueLicence.toUpperCase().indexOf(filter) > -1) {
